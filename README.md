...
2. Carregamento e Tratamento dos Dados: Lê o arquivo de entrada e garante que os dados estejam no formato correto para análise.
3. Definição dos Parâmetros do Teste Z: Configura o limiar de sobrevivência e o nível de significância para o teste estatístico.
...
6. Visualização e Interpretação dos Resultados: Exibe os resultados finais e fornece um guia para entender o que cada coluna significa, especialmente a coluna 'significativo'.
